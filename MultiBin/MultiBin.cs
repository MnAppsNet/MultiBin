...
namespace MultiBin
{
    public partial class MultiBin : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            keyboardEvents.AddEvent("Testing", new Keys[] { Keys.LControlKey, Keys.LShiftKey, Keys.Space },this , "openBin", new object[0]);
            ...
            else
            {
                ...
                if (item.Type == DataFormats.FileDrop)
                {
                    ...
                    if (files.Length > 0)
                    {
                        ...
                        fileItem.MouseClick += binItem_MouseClick;
                        ...
                        foreach (Control c in fileItem.Controls)
                        {
                            ...
                            {
                                c2.Tag = item.ID;
                                c2.MouseClick += binItem_MouseClick;
                            }
                            c.Tag = item.ID;
                            c.MouseClick += binItem_MouseClick;
                        }
                ...
                else if (item.Type == DataFormats.Bitmap)
                {
                    ...
                    imageItem.MouseClick += binItem_MouseClick;
                ...
                else if (item.Type == DataFormats.Rtf)
                {
                    ...
                    rtfItem.MouseClick += binItem_MouseClick;
                    rtfItem.Tag = item.ID;
                ...
                else if (item.Type == DataFormats.UnicodeText)
                {
                    ...
                    textItem.MouseClick += binItem_MouseClick;
